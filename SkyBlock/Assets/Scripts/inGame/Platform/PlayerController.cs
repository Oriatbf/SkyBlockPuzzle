    ...
    public void Detect()
    {
        ...
        Collider[] colliders = Physics.OverlapSphere(this.transform.position, 1.8f, MoveTile);
            foreach (Collider collider in colliders)
            {
                ...
                {
                    if (!Physics.Raycast(hit.transform.position + new Vector3(0, 0.6f, 0), Quaternion.Euler(0, 270, 0) * new Vector3(0, 0, -1), 1.8f, PushStopBlock) &&
                        Physics.Raycast(hit.transform.position + new Vector3(0, 0.6f, 0), Quaternion.Euler(0, 90, 0) * new Vector3(0, 0, -1), 2f, PlayerLayer) ||
                         !Physics.Raycast(hit.transform.position + new Vector3(0, 0.6f, 0), Quaternion.Euler(0, 90, 0) * new Vector3(0, 0, -1), 1.8f, PushStopBlock) &&
                        Physics.Raycast(hit.transform.position + new Vector3(0, 0.6f, 0), Quaternion.Euler(0, 270, 0) * new Vector3(0, 0, -1), 2f, PlayerLayer) ||
                         !Physics.Raycast(hit.transform.position + new Vector3(0, 0.6f, 0), Quaternion.Euler(0, 180, 0) * new Vector3(0, 0, -1), 1.8f, PushStopBlock) &&
                        Physics.Raycast(hit.transform.position + new Vector3(0, 0.6f, 0), Quaternion.Euler(0, 0, 0) * new Vector3(0, 0, -1), 2f, PlayerLayer) ||
                         !Physics.Raycast(hit.transform.position + new Vector3(0, 0.6f, 0), Quaternion.Euler(0, 0, 0) * new Vector3(0, 0, -1), 1.8f, PushStopBlock) &&
                        Physics.Raycast(hit.transform.position + new Vector3(0, 0.6f, 0), Quaternion.Euler(0, 180, 0) * new Vector3(0, 0, -1), 2f, PlayerLayer))
                    {
