...
public class MapButton : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (InterectionUi.isOptionCanvas == false && InterectionUi.isDogamCanvas == false)
            {
                SlideWait = true;
        ...
        //맵 변경
        if (slideNum == 3 && MAPNum != 4 && MAPNum != 1 && Clcam.Go == false
            || UILeftRightNum == 2 && MAPNum != 4 && MAPNum != 1 && Clcam.Go == false)
        {
            UILeftRightNum = 0;
            MAPNum += 1;
            slideNum = 0;
        ...
        if (slideNum == 4 && MAPNum != 2 && MAPNum != 1 && Clcam.Go == false
            || UILeftRightNum == 1 && MAPNum != 2 && MAPNum != 1 && Clcam.Go == false)
        {
            UILeftRightNum = 0;
            MAPNum -= 1;
            slideNum = 0;
